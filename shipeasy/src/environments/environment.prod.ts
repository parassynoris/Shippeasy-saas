...
export const environment = {
  ...
  isEncryption:false,
  secretkey :"BYUKXCRPHYRFOJINZHPSXZMQEULXFJOF",
  baseUrlMaster: 'https://shippeasy-api.synoris.co/api/',
  ...
  username: 'vikash.subudhi2211@gmail.com',
  password: "Tead@1",
  ...
  socketUrl:"https://shippeasy-api.synoris.co",

...
describe('LabelsComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [LabelsComponent, MockTranslatePipe],
  ...
  it('should not return next object if it is not an object', () => {
    const obj = 'string';
    expect(component.getNextObj(obj)).toBeUndefined();
  });

  it('should return true if key value is an object', () => {
    const obj = { value: { key: 'value' } };
    expect(component.doCheck(obj)).toBeTrue();
  });

  it('should return false if key value is not an object', () => {
    const obj = { value: 'string' };
    expect(component.doCheck(obj)).toBeFalse();
  });
});

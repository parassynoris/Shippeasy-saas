...
const CUSTOM_INPUT_CONTROL_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => ShippingBillComponent),
  multi: true
};
...
describe('ShippingBillComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [ShippingBillComponent,MockTranslatePipe],
  ...
  it('should clear global search and reset data', () => {
    spyOn(component, 'getshippingbill');
    component.clearGloble();
    expect(component.globalSearch).toBe('');
    expect(component.getshippingbill).toHaveBeenCalled();
  });

  it('should paginate to the next page', () => {
    spyOn(component, 'getPaginationData');
    component.toalLength = 100;
    component.count = 50;
    component.next();

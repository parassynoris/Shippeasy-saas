...
import { CostHeadMappingComponent } from './cost-head-mapping.component';
...
describe('CostHeadMappingComponent', () => {
  let component: CostHeadMappingComponent;
  let fixture: ComponentFixture<CostHeadMappingComponent>;
  ...
  beforeEach(waitForAsync(() => {
   ...
   mockApiService = jasmine.createSpyObj('ApiService',['getListByURL']);
    TestBed.configureTestingModule({
      declarations: [CostHeadMappingComponent, MockTranslatePipe],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(CostHeadMappingComponent);

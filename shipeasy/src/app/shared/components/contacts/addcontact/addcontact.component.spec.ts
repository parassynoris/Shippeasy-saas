...
describe('AddcontactComponent', () => {
  ...
  let mockCommonService: jasmine.SpyObj<CommonService>;
    ...
    TestBed.configureTestingModule({
      declarations: [AddcontactComponent, MockTranslatePipe,],
  ...
  it('should initialize the form', () => {
    expect(component.addContactForm).toBeDefined();
    expect(component.addContactForm.get('contactName')).toBeDefined();
    expect(component.addContactForm.get('contactEmail')).toBeDefined();
    // Add expectations for other form controls and validators
  });
  ...
  it('should submit the form', () => {
    spyOn(component, 'SaveContact').and.callThrough();
    component.SaveContact();
    expect(component.submitted).toBeTrue();
  });
  
  it('should initialize form controls with validity', () => {
    expect(component.addContactForm.get('contactName').valid).toBeFalse(); // Expect invalid initially
    expect(component.addContactForm.get('contactEmail').valid).toBeFalse(); // Expect invalid initially
    // Add expectations for other form controls' initial validity
  });

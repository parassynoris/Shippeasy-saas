...
import { LocalTariffComponent } from './local-tariff.component';
...
describe('LocalTariffComponent', () => {
  let component: LocalTariffComponent;
  let fixture: ComponentFixture<LocalTariffComponent>;
  ...
  beforeEach(waitForAsync(() => {
   ...
   mockApiService = jasmine.createSpyObj('ApiService',['getListByURL']);
    TestBed.configureTestingModule({
      declarations: [LocalTariffComponent, MockTranslatePipe],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(LocalTariffComponent);

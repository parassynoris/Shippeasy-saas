...
import { PDATemplatesComponent } from './pda-templates.component';
...
describe('PDATemplatesComponent', () => {
  let component:PDATemplatesComponent;
  let fixture: ComponentFixture<PDATemplatesComponent>;
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [PDATemplatesComponent, MockTranslatePipe],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(PDATemplatesComponent);

...
describe('AddportComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
   ...
   mockApiService = jasmine.createSpyObj('ApiService',['getListByURL']);
    TestBed.configureTestingModule({
      declarations: [AddportComponent, MockTranslatePipe],
  ...
  it('should initialize locationForm correctly on ngOnInit', () => {
    component.ngOnInit();
    expect(component.locationForm).toBeTruthy();
    // Add more expectations for form initialization if needed
  });

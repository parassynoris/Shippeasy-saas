...
const CUSTOM_INPUT_CONTROL_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => ClauseComponent),
  multi: true
};
...
describe('ClauseComponent', () => {
  ...
  let mockCommonService: jasmine.SpyObj<CommonService>;
    ...
    TestBed.configureTestingModule({
      declarations: [ClauseComponent, MockTranslatePipe,],
  ...
  it('should call getAll method on ngOnChanges', () => {
    spyOn(component, 'getAll');
    component.ngOnChanges();
    expect(component.getAll).toHaveBeenCalled();
  });

  it('should update size and fromSize correctly and call getAll method on filter', () => {

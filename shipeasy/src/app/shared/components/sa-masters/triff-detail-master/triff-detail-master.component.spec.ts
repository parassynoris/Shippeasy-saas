...
import { TriffDetailMasterComponent } from './triff-detail-master.component';
...
const CUSTOM_INPUT_CONTROL_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => TriffDetailMasterComponent),
  multi: true
};

describe('TriffDetailMasterComponent', () => {
  let component: TriffDetailMasterComponent;
  let fixture: ComponentFixture<TriffDetailMasterComponent>;
  ...
  let mockCommonService: jasmine.SpyObj<CommonService>;
    ...
    TestBed.configureTestingModule({
      declarations: [TriffDetailMasterComponent, MockTranslatePipe,],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(TriffDetailMasterComponent);
  ...
  it('should open modal', () => {
    const modalContent = 'modal content'; // Provide your modal content here
    component.open(modalContent);
    expect(mockNgbModal.open).toHaveBeenCalledWith(modalContent, jasmine.any(Object));
  });

  it('should delete clause', () => {
    const mockId = 'mockId'; // Provide a mock id here
    spyOn(window, 'alert');
  
    component.deleteclause(mockId);

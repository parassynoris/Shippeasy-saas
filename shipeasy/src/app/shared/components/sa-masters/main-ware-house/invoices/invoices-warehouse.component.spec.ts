...
import { InvoicesWarehouseComponent } from './invoices-warehouse.component';
...
describe('InvoicesWarehouseComponent', () => {
  let component: InvoicesWarehouseComponent;
  let fixture: ComponentFixture<InvoicesWarehouseComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      declarations: [ InvoicesWarehouseComponent,MockOrderByPipe  ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(InvoicesWarehouseComponent);

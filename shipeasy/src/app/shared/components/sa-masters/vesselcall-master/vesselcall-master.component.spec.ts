...
import { VesselcallMasterComponent } from './vesselcall-master.component';
...
describe('VesselcallMasterComponent', () => {
  let component: VesselcallMasterComponent;
  let fixture: ComponentFixture<VesselcallMasterComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      declarations: [ VesselcallMasterComponent ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(VesselcallMasterComponent);
  ...
  it('should set isSearchable to true', () => {
    // Arrange - set initial state if needed
    ...
    // Assert
    expect(component.isSearchable).toBeTruthy();
  });

  it('should return the controls of addVesselCallForm', () => {
    const mockFormGroup = {
      controls: {
      }
    };
  
    component.addVesselCallForm = mockFormGroup as any;
    const formControls = component.f;
    expect(formControls).toEqual(mockFormGroup.controls);
  });

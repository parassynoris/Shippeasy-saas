...
import { CommodityGroupMasterComponent } from './commodity-group-master.component';
...
const CUSTOM_INPUT_CONTROL_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => CommodityGroupMasterComponent),
  multi: true
};
...
describe('CommodityGroupMasterComponent', () => {
  let component: CommodityGroupMasterComponent;
  let fixture: ComponentFixture<CommodityGroupMasterComponent>;
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [CommodityGroupMasterComponent, MockTranslatePipe,],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(CommodityGroupMasterComponent);

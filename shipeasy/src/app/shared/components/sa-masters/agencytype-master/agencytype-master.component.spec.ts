...
import { AgencytypeMasterComponent } from './agencytype-master.component';
...
describe('AgencytypeMasterComponent', () => {
  ...
  it('should open modal', () => {
    const content = 'content'; // provide some content to pass to the modal
    component.open(content);
    expect(mockNgbModal.open).toHaveBeenCalledWith(content, jasmine.objectContaining({

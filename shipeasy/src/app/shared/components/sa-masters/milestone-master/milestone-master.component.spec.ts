...
import { MilestoneMasterComponent } from './milestone-master.component';
...
const CUSTOM_INPUT_CONTROL_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => MilestoneMasterComponent),
  multi: true
};
 
describe('MilestoneMasterComponent', () => {
  let component: MilestoneMasterComponent;
  let fixture: ComponentFixture<MilestoneMasterComponent>;
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [MilestoneMasterComponent,MockTranslatePipe],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(MilestoneMasterComponent);

...
import { StoltBLComponent } from './stolt-bl.component';
...
describe('StoltBLComponent', () => {
  let component: StoltBLComponent;
  let fixture: ComponentFixture<StoltBLComponent>;
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [StoltBLComponent, MockTranslatePipe],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(StoltBLComponent);
  ...
  it('should update size and call getblData on filter', () => {
    const event = { target: { value: 20 } };
    spyOn(component, 'getblData');
    
    component.filter(event);
    
    expect(component.size).toEqual(20);
    expect(component.fromSize).toEqual(1);
    expect(component.getblData).toHaveBeenCalled();
  });

  it('should call getPaginationData with prev parameter when prev is called', () => {
    component.page = 2;
  ...
  it('should call getblData method', () => {
    spyOn(component, 'getblData');
    component.getblData();
    expect(component.getblData).toHaveBeenCalled();
  });
  ...
  it('should call next and get next pagination data', () => {
    spyOn(component, 'getPaginationData');
  ...
  it('should call prev and get previous pagination data', () => {
    spyOn(component, 'getPaginationData');
    component.page = 2;
    component.prev();
    expect(component.getPaginationData).toHaveBeenCalledWith('prev');

...
import { ConatinerTrackComponent } from './container-track.component';
...
const CUSTOM_INPUT_CONTROL_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => ConatinerTrackComponent),
  multi: true
};

describe('ConatinerTrackComponent', () => {
  let component: ConatinerTrackComponent;
  let fixture: ComponentFixture<ConatinerTrackComponent>;
  ...
  let mockCommonService: jasmine.SpyObj<CommonService>;
    ...
    TestBed.configureTestingModule({
      declarations: [ConatinerTrackComponent, MockTranslatePipe,],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ConatinerTrackComponent);

...
describe('ContainerComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
   ...
   mockApiService = jasmine.createSpyObj('ApiService',['getListByURL']);
    TestBed.configureTestingModule({
      declarations: [ContainerComponent, MockTranslatePipe],
  ...
  it('should initialize the form group', () => {
    ...
    expect(component.addContainerForm.get('yard')).toBeTruthy();
    expect(component.addContainerForm.get('containerType')).toBeTruthy();
});

it('should fetch container type dropdowns', () => {
  component.ngOnInit(); 
});

it('should do nothing on selecting a container', () => {
  // Arrange
  const event = { /* Mock event object */ };
  // Act
  component.onSelectContainer(event);

...
const CUSTOM_INPUT_CONTROL_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => PayModalComponent),
  multi: true
};
...
describe('PayModalComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    mockNgbActiveModal = jasmine.createSpyObj('NgbActiveModal', ['open']);
    ...
    TestBed.configureTestingModule({
      declarations: [PayModalComponent, MockTranslatePipe],
      ...
      providers: [DatePipe, OrderByPipe,
        ...
        { provide: NgbActiveModal, useVale: mockNgbActiveModal },

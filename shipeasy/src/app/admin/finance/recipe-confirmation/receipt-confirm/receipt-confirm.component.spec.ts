...
import { ReceiptConfirmComponent } from './receipt-confirm.component';
...
const CUSTOM_INPUT_CONTROL_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => ReceiptConfirmComponent),
  multi: true
};

describe('ReceiptConfirmComponent', () => {
  let component: ReceiptConfirmComponent;
  let fixture: ComponentFixture<ReceiptConfirmComponent>;
  ...
  let mockCommonService: jasmine.SpyObj<CommonService>;
    ...
    TestBed.configureTestingModule({
      declarations: [ReceiptConfirmComponent, MockTranslatePipe,],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ReceiptConfirmComponent);
  ...
  it('should emit event to close invoice section', () => {
    const mockEvent = 'close';
    spyOn(component.CloseInvoiceSection, 'emit');
  
    component.onCloseInvoice(mockEvent);
  
    expect(component.CloseInvoiceSection.emit).toHaveBeenCalledWith(mockEvent);
  });

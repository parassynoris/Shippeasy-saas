...
import { UpdateMasterBlComponent } from './update-master-bl.component';
...
describe('UpdateMasterBlComponent', () => {
  let component: UpdateMasterBlComponent;
  let fixture: ComponentFixture<UpdateMasterBlComponent>;
  ...
  beforeEach(waitForAsync(() => {
   ...
   mockApiService = jasmine.createSpyObj('ApiService',['getListByURL']);
    TestBed.configureTestingModule({
      declarations: [UpdateMasterBlComponent, MockTranslatePipe],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(UpdateMasterBlComponent);
  ...
  it('should call getSTList method of common service for shipping lines', () => {
    component.getShippingLineDropDowns();
  });

  it('should call getSTList method of common service for BLs', () => {
    component.getBLById();
  });

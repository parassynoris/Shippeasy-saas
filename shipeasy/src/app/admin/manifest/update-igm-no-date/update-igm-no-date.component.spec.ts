...
import { UpdateIgmNoDateComponent } from './update-igm-no-date.component';
...
describe('UpdateIgmNoDateComponent', () => {
  ...
  let component: UpdateIgmNoDateComponent;
  let fixture: ComponentFixture<UpdateIgmNoDateComponent>;

  beforeEach(async () => {
    mockApiService = jasmine.createSpyObj('ApiService', ['getSTList', 'addToST', 'UpdateToST', 'deleteST']);
    await TestBed.configureTestingModule({
      declarations: [ UpdateIgmNoDateComponent ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(UpdateIgmNoDateComponent);
  ...
  it('should initialize the form correctly', () => {
    ...
    // Add more expectations based on your form structure
  });

  it('should initialize component properties correctly', () => {
    expect(component.blForm).toBeDefined();
    expect(component.houseBlList).toEqual([]);
    // Add more expectations based on other properties initialization
  });
  it('should initialize BL form with empty array', () => {
    expect(component.blForm).toBeDefined();
    expect(component.blForm.get('blData').value).toEqual([]);
  });

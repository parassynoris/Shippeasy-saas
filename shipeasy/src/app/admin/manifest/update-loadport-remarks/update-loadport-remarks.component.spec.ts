...
import { UpdateLoadportRemarksComponent } from './update-loadport-remarks.component';
...
describe('UpdateLoadportRemarksComponent', () => {
  
  let component: UpdateLoadportRemarksComponent;
  let fixture: ComponentFixture<UpdateLoadportRemarksComponent>;
  ...
  beforeEach(async () => {
    ...
    commonServiceSpy = jasmine.createSpyObj('CommonService', ['getSTList']);
    await TestBed.configureTestingModule({
      declarations: [ UpdateLoadportRemarksComponent ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(UpdateLoadportRemarksComponent);
    component = fixture.componentInstance;
    fixture.detectChanges();
    formBuilder = TestBed.inject(FormBuilder);
    component.blForm = formBuilder.group({
      blData: formBuilder.array([])
    });
  });
  ...
  it('should return the blForm controls as FormArray', () => {
    expect(component.bl instanceof FormArray).toBeTruthy();
  });

  it('should return the controls of blForm as FormArray controls', () => {
    const controls = component.getControls();
    expect(controls).toEqual(component.bl.controls);
  });

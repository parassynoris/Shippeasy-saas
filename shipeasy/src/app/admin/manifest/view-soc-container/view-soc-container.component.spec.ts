...
import { ViewSocContainerComponent } from './view-soc-container.component';
...
describe('ViewSocContainerComponent', () => {
  let component: ViewSocContainerComponent;
  let fixture: ComponentFixture<ViewSocContainerComponent>;
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [ViewSocContainerComponent, MockTranslatePipe],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ViewSocContainerComponent);
  ...
  it('should handle large datasets for excel', () => {
    component.houseBlList = new Array(1000).fill({}); // Simulate large data
    const startTime = performance.now();
    component.excel();
    const endTime = performance.now();
    expect(endTime - startTime).toBeLessThan(1000); // Ensure reasonable execution time
  });

...
@Component({
  selector: 'app-edit-terminal-fpod',
  templateUrl: './edit-terminal-fpod.component.html',
  styleUrls: ['./edit-terminal-fpod.component.css']
})
export class EditTerminalFpodComponent {
  houseBlList:any=[]
  blForm: FormGroup
  portList:any=[]
  itemTypeList:any=[]

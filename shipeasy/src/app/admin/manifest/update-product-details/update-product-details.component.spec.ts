...
const CUSTOM_INPUT_CONTROL_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => UpdateProductDetailsComponent),
  multi: true
};
...
describe('UpdateProductDetailsComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [UpdateProductDetailsComponent, MockTranslatePipe],
  ...
  it('should create the component', () => {
    const fixture = TestBed.createComponent(UpdateProductDetailsComponent);
    const component = fixture.componentInstance;
    expect(component).toBeTruthy();
  });

  describe('ngOnInit', () => {
    it('should call getVoyage and getVesselData on init', () => {
      spyOn(component, 'getVoyage').and.callThrough();
      spyOn(component, 'getVesselData').and.callThrough();

      component.ngOnInit();

      expect(component.getVoyage).toHaveBeenCalled();
  ...
  describe('getBLById', () => {
    it('should populate houseBlList and call buildForm', () => {
      const mockBLData = { documents: [{ productId: '1', blNumber: 'BL123' }] };
      const mockProductData = [{ productId: '1', packingGroup: 'Group1', packingGroupName: 'Name1', productType: 'Type1' }];

      mockCommonService.getSTList.and.returnValue(of(mockBLData));
      ...
      expect(component.houseBlList.length).toBeGreaterThan(0);

...
import { HouseBlComponent } from './house-bl.component';
...
describe('HouseBlComponent', () => {
  let component: HouseBlComponent;
  let fixture: ComponentFixture<HouseBlComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      declarations: [ HouseBlComponent ,MastersSortPipe],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(HouseBlComponent);
  ...
  it('should call getBLById on init', () => {

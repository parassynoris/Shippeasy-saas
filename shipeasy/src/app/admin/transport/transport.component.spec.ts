...
describe('TransportComponent', () => {
  ...
  it('should call getEnquiryList on initialization', () => {
    spyOn(component, 'getEnquiryList').and.callThrough();
    component.ngOnInit();
    expect(component.getEnquiryList).toHaveBeenCalled();
  });

  it('should call getEnquiryList on init', () => {
    spyOn(component, 'getEnquiryList').and.callThrough();
    component.ngOnInit();
    expect(component.getEnquiryList).toHaveBeenCalled();
  });

  it('should clear filters and call getEnquiryList', () => {
    spyOn(component, 'getEnquiryList').and.callThrough();
  ...
  it('should navigate to the correct URL using navigateToNewTab', () => {
    const element = { transportinquiryId: '456' };
    spyOn(component.router, 'navigate');
  
    component.navigateToNewTab(element);
  
    expect(component.router.navigate).toHaveBeenCalledWith(['/rfq/list/456/details']);
  });
  it('should navigate to the details view of an inquiry using viewDetails', () => {
    const element = { transportinquiryId: '123' };
    spyOn(component.router, 'navigate');
  
    component.viewDetails(element);
  
    expect(component.router.navigate).toHaveBeenCalledWith(['/rfq/list/123/details']);
  });
